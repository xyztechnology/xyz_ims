...
namespace InventroryManagementSystem.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
       ...
       // public DbSet<TaxCode> TaxCode { get; set; }
        ...
        public DbSet<PurchaseOrderAnalayis> PurchaseOrderAnalayis { get; set; }
        ...
        public DbSet<PurchaseRequisitionLine> PurchaseRequisitionLine { get; set; }

        public DbSet<TransactionAnalysisSetup> TransactionAnalysisSetup { get; set; }
        public DbSet<TransactionAnalysisSubSetup> TransactionAnalysisSubSetup { get; set; }
        public DbSet<ReceivedOrder> ReceivedOrder { get; set; }
        public DbSet<ReceivedOrderDetail> ReceivedOrderDetail { get; set; }
